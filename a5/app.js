...
document.addEventListener("DOMContentLoaded", function(){
	new Vue({
		...
		template: `<div id="app">
			...
			Presents: {{bot.presents}}/{{bot.maxPresents}} presents remain
			...
			<div id="controls">
				...
				<div>
					<button @click="handleInput('new presents')">new presents plz!</button>
					<button @click="handleInput('open')">open 🎁</button>
					<button @click="handleInput('DO NOT CLICK')">DO NOT CLICK</button>
				</div>
